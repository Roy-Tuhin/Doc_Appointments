...
class _HealthDetailsPageRefState extends State<HealthDetailsPageRef> {
  ...
  var encHealthPartnerIdRef;
  _HealthDetailsPageRefState(this.encHealthPartnerIdRef);
  @override
  ...
  Future<HealthDetailsRefactorModel> HeathDetailsRefacApi() async {
    ...
    var response = await http.post(
        Uri.parse("https://medbo.in/api/medboapi/healthdetails"),
        body: ({"EncId": encHealthPartnerIdRef}));
    if (response.statusCode == 200) {
      ...
      HealthDetailsRefactorModel dataModel =
          healthDetailsRefactorModelFromJson(response.body);
      return dataModel;
    } else {
      print("Wrong Url");
      print(response.body);
