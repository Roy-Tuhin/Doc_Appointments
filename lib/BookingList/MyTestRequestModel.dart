...
//
//     final myTestRequestModel = myTestRequestModelFromJson(jsonString);

import 'package:meta/meta.dart';
import 'dart:convert';

MyTestRequestModel myTestRequestModelFromJson(String str) => MyTestRequestModel.fromJson(json.decode(str));

String myTestRequestModelToJson(MyTestRequestModel data) => json.encode(data.toJson());

class MyTestRequestModel {
    MyTestRequestModel({
    ...
    String status;
    String message;
    List<TestRequest> data;

    factory MyTestRequestModel.fromJson(Map<String, dynamic> json) => MyTestRequestModel(
        status: json["Status"],
        message: json["Message"],
        data: List<TestRequest>.from(json["Data"].map((x) => TestRequest.fromJson(x))),
    );
